...
其中D类和C类动作按照发生时视为的阶段进行AP回复。
 ...
 法术、人偶、召唤兽的范围不超过1.5m的攻击视为格斗武器，适用布线器与增幅器的尺寸回复AP.
 法术、人偶、召唤兽的范围超过1.5m的攻击视为射击武器，将布线器与增幅器的尺寸向下一个档次后计算AP回复。
...
入构阶段：叙述者由于动作的后果而无法自由活动的阶段，此时的叙述者不能进行任何动作，此时动作要素占用解除，叙述者可以正常的回复FP与PP，但是在规则上仍旧会被占用的要素所对应的FP/PP损伤造成硬直。
...
#### 4.6.6架势[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id273)
...
##### 4.6.6.1 架势的分类与特点[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id274)
...
##### 4.6.6.2 架势的使用[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id275)
...
##### 4.11.5.1动作结束后稳定值的计算[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id393)
...
#### 4.11.5奥义[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id299)
...
##### 4.11.5.1奥义值[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id300)

###### 4.11.5.1.1奥义值上限[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id301)

奥义值是决定角色能够使用奥义的数值，与FP和PP类似，其拥有上限，但不同的是，奥义值在战斗开始时为0，随着角色每次执行攻击动作而获得奥义值。
 奥义值的上限由角色的智力与力量共同决定，并且可以通过其他的能力、技能进行调整。
 奥义值上限=50+智力/2+力量/4

###### 4.11.5.1.2奥义值的获取[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id302)
...
##### 4.11.5.2使用奥义[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id303)

###### 4.11.5.2.1奥义姿态[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id304)
...
###### 4.11.5.2.2寂心姿态[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id305)
...
###### 4.11.5.2.3心解姿态[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id306)
...
###### 4.11.5.2.4使用奥义[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id307)
...
调整射角：对处于射角范围外的敌人进行射击时，将会强制转身至正对目标，即调整至目标位于自身正面，这被称作调整射角，所使用的的速度为标准转身速度。调整射角的时间在规则上属于额外的准备时间，会触发与准备时间有关的负面效果，但是不会触发与准备时间有关的强化效果。
...
当17＞法术波动强度-法术感知时，视为叙述者对这个法术自动完成了法术辩识。
...
类法术通常而言以能力的形式存在，且除了召唤术外的类法术通常都不会占用灵魂容量，因此不能使用法术的种族也可以学习并且使用类法术。

使用类法术能力时仍旧需要像动作一般占用要素以及发生时间，但是与施法动作不同，初期的类法术能力除了召唤术以及其他需要使用增幅器作为攻击力的类法术能力以外，都不能在拔出武器的情况下施展。
...
召唤术：在一众类法术中较为特殊的一种，使用能力：召唤之门将缔结契约的召唤兽拉入战场并进行战斗，与其他类法术不同的是，召唤术必须装备增幅器才能够使用。
...
9.3.1 可选规则：更加平滑的投掷数值[](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id242)
...
## 六 战斗环境[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id368)
...
### 6.1 大气[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id369)

#### 6.1.1 温度[Á](https://lcdsv1docs.readthedocs.io/en/latest/RulesBook.html#id370)
